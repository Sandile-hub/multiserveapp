          ...
          <div className="customer-sidebar-header">
            ...
            {!collapsed && (
              <div className="customer-sidebar-brand">
                ...
                <h1 className="customer-sidebar-logo">
                  MultiServe
                </h1>

                <p className="customer-sidebar-subtitle">
                  Customer Dashboard
                </p>
            ...
            <button
              onClick={onClose}
              className="customer-sidebar-mobile-close"
            >
              <X size={22} />
            </button>
        ...
        <div className="customer-sidebar-user">
          ...
          >
            ...
            <div className="customer-user-avatar-wrapper">
              ...
              <div className="customer-user-online" />
            ...
            {menuItems.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  {isActive && (
                    <div className="customer-nav-active-glow" />
                  )}
